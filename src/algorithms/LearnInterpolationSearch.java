...
public class LearnInterpolationSearch {
    public static void main(String[] args) {
         ...
         * distributed data "guesses" where a value might be based on calculated probe
         * results if probe is incorrect, search area i narrowed, and a new probe is
         * calculated
         * 
        ...
        index = interpolationSearch(array, 11);
        if (index != -1) {
            System.out.println("Element found at index: " + index);
        } else {
            System.out.println("Element not found");
